    ...
    public class NewZealandWalksDbcontext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            var Difficulties = new List<Difficulty>() {
                new Difficulty(){
                    ID=Guid.Parse("3843e0ff-2531-4385-b48b-dade86fd1430"),
                    Name="Easy"
                },
                new Difficulty(){
                    ID=Guid.Parse("7a426df6-0346-4cc9-b793-f1a502468871"),
                    Name="Medium"
                },
                 new Difficulty(){
                     ID=Guid.Parse("7a0d6538-b7eb-4bfd-9689-38b8b94601e8"),
                     Name="Hard"
                }
            };
